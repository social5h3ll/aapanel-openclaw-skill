...
# dev environment: src/bt_common/ (脚本在 src/bt_common/scripts/)
_script_root = Path(__file__).parent.parent
if (_script_root / "bt_common").exists():
    # release environment: 脚本在 {baseDir}/scripts/，bt_common 在 {baseDir}/bt_common/
    sys.path.insert(0, str(_script_root))
else:
    # dev environment: 脚本在 src/bt_common/scripts/，bt_common 在 src/bt_common/
    sys.path.insert(0, str(_script_root))
