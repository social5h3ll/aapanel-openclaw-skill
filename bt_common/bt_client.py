...
class BtClient:
    ...
    def request(self, endpoint: str, params: Optional[dict] = None) -> dict:
        ...
        try:
            ...
            # 检查宝塔APIresponsestatus
            # 注意：某些 API return的是列表而不是字典
    ...
    def get_service_list(self) -> list:
        ...
        # 宝塔 API 可能return status=false 的errorresponse
    ...
    def get_all_sites(self) -> list:
        ...
        # 获取各type项目（Java/Node/Go/Python/net/Proxy/HTML/Other）
    ...
    def get_service_status(self, service: str) -> dict:
        ...
        if service == "pgsql":
            ...
            if result.get("status") and "data" in result:
                # 解析pgsqlstatus格式: {"data": ["开启", 1], "status": true}
